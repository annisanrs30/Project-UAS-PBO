...
public class Projectkalkulatorpbo extends javax.swing.JDialog {
    private String tmp = "";
    private int pilih;
    private float a1,a2,hasil;
    
    public Projectkalkulatorpbo(java.awt.Frame parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Projectkalkulatorpbo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Projectkalkulatorpbo dialog = new Projectkalkulatorpbo(new javax.swing.JFrame(), true);
